    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs Nexon</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=628888375863">WhatsApp</a></span></span>
      ...
      let mailOptions = {
        from: '"Nexon" <nexonnjs@gmail.com>',
        to: email,
        subject: 'Verify Email - Api Nexon',
        html: inboxGmail,
      };
