...
// User Login
$.getJSON("https://api.countapi.xyz/hit/api.nexon.my.id/userlogin", function(response) {
    $("#userlogin").text(response.value);
})

// Request Today
$.getJSON("https://api.countapi.xyz/hit/api.nexon.my.id/requesttoday", function(response) {
    $("#requesttoday").text(response.value);
})

// Total Request
$.getJSON("https://api.countapi.xyz/hit/api.nexon.my.id/totalrequest", function(response) {
